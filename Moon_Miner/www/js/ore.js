export class Ore_Controller {
  constructor() {
    ...
    this.upgrade_cost_storage_span = document.getElementById(
  ...
  upgradeMining(RC) {
    ...
    if (counter === 5) {
      for (var item in RC.material_count) {
        RC.material_count[item] =
          RC.material_count[item] - this.upgrade_cost_mining_yield[item];
        this.upgrade_cost_mining_yield[item] = Math.round(
          this.upgrade_cost_mining_yield[item] * 1.6
        );
      }
  ...
  updateMiningYieldUpgradeCost() {
    document.getElementById(
      "upgrade_cost_mining_iron"
    ).innerText = this.upgrade_cost_mining_yield["Iron"];
    document.getElementById(
      "upgrade_cost_mining_silicon"
    ).innerText = this.upgrade_cost_mining_yield["Silicon"];
    document.getElementById(
      "upgrade_cost_mining_copper"
    ).innerText = this.upgrade_cost_mining_yield["Copper"];
    document.getElementById(
      "upgrade_cost_mining_silver"
    ).innerText = this.upgrade_cost_mining_yield["Silver"];
    document.getElementById(
      "upgrade_cost_mining_gold"
    ).innerText = this.upgrade_cost_mining_yield["Gold"];
  }
}
